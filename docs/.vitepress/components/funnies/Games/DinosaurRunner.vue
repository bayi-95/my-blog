<template>
  <div class="comp-dinosaur-runner">
    <div id="runner-container" class="runner-container offline"></div>
    <img
      id="sprite"
      style="display: none"
...
export default defineComponent({
  ...
  methods: {
    startGame() {
      ...
      canvas.id = 'c'
      canvas.width = this.canvasWidth || 600
      canvas.height = 150
      ...
      Runner.prototype = {
        ...
        onKeyDown: function (e) {
          if (e.target != this.detailsButton) {
            if (!this.crashed && (Runner.keycodes.JUMP[e.keyCode] || (this.isMobile() && e.type === 'mousedown'))) {
              e.preventDefault()
              if (!this.activated) {
                this.loadSounds()
                this.activated = true
      ...
      function drawCollisionBoxes(canvasCtx, tRexBox, obstacleBox) {
        ...
        canvasCtx.strokeRect(obstacleBox.x + 0.5, obstacleBox.y + 0.5, obstacleBox.width, obstacleBox.height)
        canvasCtx.restore()
      }
