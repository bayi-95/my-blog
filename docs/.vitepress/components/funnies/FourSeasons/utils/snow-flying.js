...
!(function (t, e) {
    'object' == typeof exports && 'undefined' != typeof module
        ...
        ? define(e)
        : ((t = 'undefined' != typeof globalThis ? globalThis : t || self).Snowflakes = e())
})(this, function () {
    'use strict'
    var t = ''
    function e(e, a) {
        Object.keys(a).forEach(function (n) {
            var i = n
            t && n.search('animation') > -1 && (i = t + n[0].toUpperCase() + n.substr(1)), (e.style[i] = a[n])
        })
    }
    function a(t) {
        e(t, { display: 'block' })
    ...
    'undefined' != typeof window &&
        (t =
            Array.prototype.slice
                ...
                ? ''
                : 'webkit')
    var s = 'undefined' != typeof document && 'onanimationend' in document
    function r(t, e) {
    ...
    var c = (function () {
        function t(t) {
            var e = this
            ;(this.size = 0), (this.sizeInner = 0)
            var a = (this.elem = document.createElement('div')),
                n = (this.elemInner = document.createElement('div'))
            this.update(t),
                o(a, 'snowflake'),
                o(n, 'snowflake__inner'),
                o(a, 'snowflake_animation'),
                s
                    ? (o(a, 'snowflake_animation-end'),
                      (a.onanimationend = function (t) {
                          t.target === a && (e.updateLeft(), e.reflow())
                      }))
                    : o(a, 'snowflake_animation-infinity'),
                t.types && o(n, 'snowflake__inner_type_' + r(0, t.types)),
                t.wind && o(n, 'snowflake__inner_wind'),
                t.rotation && o(n, 'snowflake__inner_rotation' + (Math.random() > 0.5 ? '' : '_reverse')),
                a.appendChild(n)
        }
        return (
            ...
            (t.prototype.updateLeft = function () {
                this.elem && e(this.elem, { left: this.getLeft() })
            }),
            (t.prototype.update = function (t) {
                if (this.elem && this.elemInner) {
                    var a = t.minSize === t.maxSize
                    ;(this.sizeInner = a ? 0 : r(0, 20)), (this.size = m(this.sizeInner, t.minSize, t.maxSize))
                    ...
                    a || (i.opacity = String(h(this.size, t.minSize, t.maxSize, t.minOpacity, t.maxOpacity))),
                        e(this.elem, i)
                    var o = 'snowflake_gid_'.concat(t.gid, '_x_').concat(this.sizeInner)
                    e(this.elemInner, { animationName: o, animationDelay: 4 * Math.random() + 's' })
                }
            }),
            (t.prototype.reflow = function () {
                this.elem && (n(this.elem), this.elem.offsetHeight, a(this.elem))
            }),
            ...
            (t.prototype.getAnimationProps = function (t) {
                ...
                return {
                    ...
                    animationDuration: String(h(this.size, t.minSize, t.maxSize, e, a) + 's')
                }
            }),
            t
        )
    ...
    return (function () {
        ...
        return (
            (t.prototype.start = function () {
                l(this.container, 'snowflakes_paused')
            }),
            (t.prototype.stop = function () {
                o(this.container, 'snowflakes_paused')
            }),
            (t.prototype.show = function () {
                l(this.container, 'snowflakes_hidden')
            }),
            ...
            (t.prototype.destroy = function () {
                this.destroyed ||
                    ...
                    screen.orientation &&
                        ...
                        screen.orientation.removeEventListener('change', this.handleOrientationChange, !1))
            }),
            (t.prototype.appendContainer = function () {
                var t = document.createElement('div')
                return (
                    o(t, 'snowflakes'),
                    o(t, 'snowflakes_gid_'.concat(this.gid)),
                    this.isBody && o(t, 'snowflakes_body'),
                    e(t, { zIndex: String(this.params.zIndex) }),
            ...
            (t.prototype.injectStyle = function (t, e) {
                return (function (t, e) {
                    return (
                        e || ((e = document.createElement('style')), document.body.appendChild(e)),
                        (e.textContent = t),
                        e
                    )
            ...
            (t.prototype.appendFlakes = function () {
                ...
                this.flakes = []
                for (var a = 0; a < this.params.count; a++) this.flakes.push(new c(e))
                this.flakes
                    .sort(function (t, e) {
            ...
            (t.prototype.getAnimationStyle = function () {
                for (
                    var t = this.params.maxSize * Math.sqrt(2),
                        e = this.isBody ? 'calc(100vh + '.concat(t, 'px)') : ''.concat(this.height() + t, 'px'),
                        a = this.gid,
                        n = '@-webkit-keyframes snowflake_gid_'
                            .concat(a, '_y{from{-webkit-transform:translateY(')
                            .concat('0px', ')}to{-webkit-transform:translateY(')
                            .concat(e, ');}}\n@keyframes snowflake_gid_')
                            .concat(a, '_y{from{transform:translateY(')
                            .concat('0px', ')}to{transform:translateY(')
                            .concat(e, ');}}'),
                        i = 0;
                    i <= 20;
                    i++
                ) {
                    var o = m(i, this.params.minSize, this.params.maxSize) + 'px'
                    n += '@-webkit-keyframes snowflake_gid_'
                        .concat(a, '_x_')
                        .concat(i, '{from{-webkit-transform:translateX(0px)}to{-webkit-transform:translateX(')
                        .concat(o, ');}}\n@keyframes snowflake_gid_')
                        .concat(a, '_x_')
                        .concat(i, '{from{transform:translateX(0px)}to{transform:translateX(')
                        .concat(o, ')}}')
                }
                return n
            }),
            ...
            (t.prototype.removeStyles = function () {
                t.instanceCounter || (i(this.mainStyleNode), delete this.mainStyleNode),
